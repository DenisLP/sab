class InspectionsController < ApplicationController
  ...
  private
    ...
    def inspection_params
      params.require(:inspection).permit(:appointment_date, :date_inspected, :site_type, :name, :contact, :email, :address, :city, :state, :zipcode, :phone_1_number, :phone_2_number, :work_assigned, :estimated_days_to_repair, :current_assignment_type, :original_assignment_type)
    end
end
